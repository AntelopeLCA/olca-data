"""
This class replicates the CSV-loading operations written in spreadsheets.py in a package, and
also supplies an Antelope archive that contains the ref data.
"""
import csv
import os
import re
